...
_L1:
        ...
        if (!jsonobject1.has("exceptions"))
        {
            break MISSING_BLOCK_LABEL_150;
        }
        jsonarray2 = jsonobject1.getJSONArray("exceptions");
...
_L2:
        ...
        while (i < jsonarray1.length()) 
        {
            ...
            try
            {
                k1.a(jsonarray1.getJSONObject(i));
            }
            catch (Exception exception2)
            {
                (new StringBuilder("Exception in HandledExceptions.fromJSON: ")).append(exception2.getClass().getName());
            }
            i++;
        }
    ...
    public static String a()
    {
        ...
        s = s1;
_L2:
        return (new StringBuilder("critter_pendingexceptions_")).append(s).toString();
        Exception exception;
        exception;
        s = new String();
...
_L1:
    ...
    public static k c()
    {
        ...
        String s;
        JSONObject jsonobject1;
        sharedpreferences = Crittercism.a().n().getSharedPreferences("com.crittercism.exceptions", 0);
        s = a();
        jsonobject1 = new JSONObject();
...
_L4:
        ...
        JVM INSTR new #33  <Class JSONObject>;
        ...
        Exception exception;
        exception;
        (new StringBuilder("Exception in HandledExceptions.readFromDisk(): ")).append(exception.getClass().getName());
_L3:
        k k2;
        String s1;
        try
...
_L1:
        ...
        try
        {
            ...
            jsonobject1.put("exceptions", jsonarray1);
        }
...
_L3:
    ...
    public final void g()
    {
        ...
        futuretask = new FutureTask(new q(this));
        ...
        if (s != null)
        {
            ...
            {
                f = new JSONObject();
                (new StringBuilder("Exception making breadcrumbs in HandledExceptions.setBreadcrumbs: ")).append(exception1.getClass().getName());
            }
        }
