...
_L3:
    ...
    ImageView getHomeActionView()
    {
        if (mHomeActionView == null)
        {
            ...
            {
                mHomeActionView = (ImageView)view2;
            }
        }
...
label0:
    ...
    private class OnMenuVisibilityListenerWrapper
    ...
    private class TabWrapper extends ActionBar.Tab
    ...
    private class OnNavigationListenerWrapper
