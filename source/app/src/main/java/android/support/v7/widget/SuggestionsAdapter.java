    ...
    implements android.view.View.OnClickListener
{
    ...
    private Drawable getDrawable(Uri uri)
    {
        ...
        ioexception1;
        Log.e("SuggestionsAdapter", (new StringBuilder("Error closing icon stream for ")).append(uri).toString(), ioexception1);
        return drawable;
        Exception exception;
        exception;
        inputstream.close();
...
_L1:
        s = getStringOrNull(cursor, mText2UrlCol);
        if (s != null)
        {
            obj = formatUrl(s);
        } else
...
_L3:
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        catch (RuntimeException runtimeexception)
        {
            ...
            View view1 = newView(mContext, mCursor, viewgroup);
            if (view1 != null)
            {
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charsequence)
    {
        ...
        Cursor cursor = getSearchManagerSuggestions(mSearchable, s, 50);
        if (cursor == null)
        {
