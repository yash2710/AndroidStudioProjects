...
_L1:
        ...
        Log.e(LOG_TAG, (new StringBuilder("Error reading historical recrod file: ")).append(mHistoryFileName).toString(), xmlpullparserexception);
...
_L3:
        ...
        ioexception1;
        Log.e(LOG_TAG, (new StringBuilder("Error reading historical recrod file: ")).append(mHistoryFileName).toString(), ioexception1);
...
_L2:
            ...
            Log.e(ActivityChooserModel.LOG_TAG, (new StringBuilder("Error writing historical recrod file: ")).append(s).toString(), filenotfoundexception);
_L3:
            return null;
_L1:
