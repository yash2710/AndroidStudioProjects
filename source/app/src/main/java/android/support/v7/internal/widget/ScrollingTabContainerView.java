    ...
    implements AdapterViewICS.OnItemClickListener
{
    ...
    public void onMeasure(int i, int j)
    {
        ...
        if (i1 > k && (l == 0x40000000 || l == 0x80000000))
        {
            int j1;
            int k1;
            int l1;
        ...
        j1 = android.view.View.MeasureSpec.makeMeasureSpec(mContentHeight, 0x40000000);
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            int i = tabView.getLeft() - (getWidth() - tabView.getWidth()) / 2;
            smoothScrollTo(i, 0);
            mTabSelector = null;
        }
