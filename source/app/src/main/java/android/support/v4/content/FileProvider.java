...
public class FileProvider extends ContentProvider
{
        ...
        implements PathStrategy
    {
        ...
        public void addRoot(String s, File file)
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder("Failed to resolve canonical path for ")).append(file).toString(), ioexception);
            }
            mRoots.put(s, file1);
        }
        ...
        public File getFileForUri(Uri uri)
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder("Failed to resolve canonical path for ")).append(file1).toString());
            }
