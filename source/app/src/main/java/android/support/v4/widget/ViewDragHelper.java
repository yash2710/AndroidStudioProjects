...
_L4:
        ...
        do
        {
            ...
            int i2 = MotionEventCompat.getPointerId(motionevent, i);
            float f2 = MotionEventCompat.getX(motionevent, i);
            float f3 = MotionEventCompat.getY(motionevent, i);
            float f4 = f2 - mInitialMotionX[i2];
            float f5 = f3 - mInitialMotionY[i2];
            ...
            if (checkTouchSlop(view, f4, f5) && tryCaptureViewForDrag(view, i2))
            {
                break;
            }
            i++;
...
_L7:
        ...
        if (mDragState != 1 || l != mActivePointerId) goto _L11; else goto _L10
_L10:
...
_L12:
        ...
        if (k1 == mActivePointerId) goto _L15; else goto _L14
_L14:
        float f;
        float f1;
        f = MotionEventCompat.getX(motionevent, i);
        f1 = MotionEventCompat.getY(motionevent, i);
        if (findTopChildUnder((int)f, (int)f1) != mCapturedView || !tryCaptureViewForDrag(mCapturedView, k1)) goto _L15; else goto _L16
_L16:
...
_L4:
        ...
        do
        {
            ...
            int i1 = MotionEventCompat.getPointerId(motionevent, l);
            float f = MotionEventCompat.getX(motionevent, l);
            float f1 = MotionEventCompat.getY(motionevent, l);
            float f2 = f - mInitialMotionX[i1];
            float f3 = f1 - mInitialMotionY[i1];
            ...
            if (view != null && checkTouchSlop(view, f2, f3) && tryCaptureViewForDrag(view, i1))
            {
                break;
            }
            l++;
