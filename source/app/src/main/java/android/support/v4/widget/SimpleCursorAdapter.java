    ...
    public void bindView(View view, Context context, Cursor cursor)
    {
        ...
        while (j < i) 
        {
            ...
            if (!flag)
            {
                ...
                {
                    throw new IllegalStateException((new StringBuilder()).append(view1.getClass().getName()).append(" is not a  view that can be bounds by this SimpleCursorAdapter").toString());
                }
            }
            j++;
        }
