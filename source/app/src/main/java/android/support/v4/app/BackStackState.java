    ...
    implements Parcelable
{
    ...
    public final BackStackRecord instantiate(FragmentManagerImpl fragmentmanagerimpl)
    {
        ...
        for (int j = 0; j < mOps.length; j = j2)
        {
            ...
            {
                Log.v("FragmentManager", (new StringBuilder("Instantiate ")).append(backstackrecord).append(" op #").append(i).append(" base fragment #").append(mOps[k]).toString());
            }
            int ai1[] = mOps;
            int l = k + 1;
            int i1 = ai1[k];
            ...
            if (k2 > 0)
            {
                ...
                for (int l2 = 0; l2 < k2;)
                {
                    if (FragmentManagerImpl.DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder("Instantiate ")).append(backstackrecord).append(" set remove fragment #").append(mOps[j2]).toString());
                    }
