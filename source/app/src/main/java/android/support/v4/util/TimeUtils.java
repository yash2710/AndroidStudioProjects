...
public class TimeUtils
{
    ...
    private static int formatDurationLocked(long l, int i)
    {
        ...
        if (i != 0)
        {
            int i4 = accumField(i1, 1, false, 0);
            boolean flag4;
            int j4;
            boolean flag5;
            int k4;
            ...
            i5 = l4 + (1 + accumField(j, 2, true, byte4));
            j2 = 0;
            for (int j5 = i5; j5 < i;)
            {
                ac[j2] = ' ';
        ...
        l2 = printField(ac, i1, 'd', k2, false, 0);
        if (l2 != k2)
        {
            flag1 = true;
        } else
        ...
        i3 = printField(ac, k1, 'h', l2, flag1, byte0);
        if (i3 != k2)
        {
            flag2 = true;
        } else
        ...
        j3 = printField(ac, i2, 'm', i3, flag2, byte1);
        if (j3 != k2)
        {
            flag3 = true;
        } else
        ...
        k3 = printField(ac, l1, 's', j3, flag3, byte2);
        if (flag && k3 != k2)
        {
            byte3 = 3;
        } else
        ...
        l3 = printField(ac, j, 'm', k3, true, byte3);
        ac[l3] = 's';
        return l3 + 1;
    }
