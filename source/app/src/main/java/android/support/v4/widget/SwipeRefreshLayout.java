...
public class SwipeRefreshLayout extends ViewGroup
{
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeset)
    {
        ...
        mActivePointerId = -1;
        mAnimateToStartPosition = new _cls1();
        mShrinkTrigger = new _cls2();
        mReturnToStartPositionListener = new _cls3();
        mShrinkAnimationListener = new _cls4();
        mReturnToStartPosition = new _cls5();
        mCancel = new _cls6();
...
*/
    ...
    private class _cls3 extends BaseAnimationListener
    {
            ...
            implements android.view.animation.Animation.AnimationListener
        {
            ...
            BaseAnimationListener(_cls1 _pcls1)
            {
                this();
            }
        }
    ...
    private class _cls4 extends BaseAnimationListener
    {
