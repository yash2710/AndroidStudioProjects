...
public final class AnimatorProxy extends Animation
{
    ...
    public final void setPivotX(float f1)
    {
        if (!d || f != f1)
        {
            a();
    ...
    public final void setPivotY(float f1)
    {
        if (!d || g != f1)
        {
            a();
    ...
    public final void setRotationX(float f1)
    {
        if (h != f1)
        {
            a();
    ...
    public final void setRotationY(float f1)
    {
        if (i != f1)
        {
            a();
    ...
    public final void setScrollX(int i1)
    {
        View view = (View)b.get();
        if (view != null)
        {
    ...
    public final void setScrollY(int i1)
    {
        View view = (View)b.get();
        if (view != null)
        {
    ...
    public final void setTranslationY(float f1)
    {
        if (n != f1)
        {
            a();
