...
final class H
{
    ...
    private H(String s, String s1, String s2, String s3, String s4, String s5, String s6, 
            String s7, long l1, I i1, Map map)
    {
        a = s;
        b = s1;
        c = s2;
    ...
    public static final H a(String s, String s1, String s2, String s3, String s4, String s5, String s6, String s7, 
            I i1, Map map)
    {
        return new H(s, s1, s2, s3, s4, s5, s6, s7, System.currentTimeMillis(), i1, map);
    }
