...
public class JsonArrayRequest extends JsonRequest
{
    ...
    protected Response parseNetworkResponse(NetworkResponse networkresponse)
    {
        ...
        try
        {
            ...
            JSONArray _tmp = JVM INSTR new #39  <Class JSONArray>;
            response = Response.success(JSONArrayInstrumentation.init(s), HttpHeaderParser.parseCacheHeaders(networkresponse));
        }
