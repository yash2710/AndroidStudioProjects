...
public class JsonObjectRequest extends JsonRequest
{
    ...
    protected Response parseNetworkResponse(NetworkResponse networkresponse)
    {
        ...
        try
        {
            String s = new String(networkresponse.data, HttpHeaderParser.parseCharset(networkresponse.headers));
            JSONObject _tmp = JVM INSTR new #12  <Class JSONObject>;
            response = Response.success(JSONObjectInstrumentation.init(s), HttpHeaderParser.parseCacheHeaders(networkresponse));
        }
