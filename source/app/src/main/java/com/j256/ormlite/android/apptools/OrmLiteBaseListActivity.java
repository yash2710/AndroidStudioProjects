    ...
    implements TraceFieldInterface
{
    ...
    {
        TraceMachine.startTracing("OrmLiteBaseListActivity");
        TraceMachine.enterMethod(_nr_trace, "OrmLiteBaseListActivity#onCreate", null);
_L1:
        if (helper == null)
        {
        ...
        nosuchfielderror;
        TraceMachine.enterMethod(null, "OrmLiteBaseListActivity#onCreate", null);
          goto _L1
    }
