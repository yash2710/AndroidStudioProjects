    ...
    implements TraceFieldInterface
{
    ...
    {
        TraceMachine.startTracing("OrmLiteBaseActivity");
        TraceMachine.enterMethod(_nr_trace, "OrmLiteBaseActivity#onCreate", null);
_L1:
        if (helper == null)
        {
        ...
        nosuchfielderror;
        TraceMachine.enterMethod(null, "OrmLiteBaseActivity#onCreate", null);
          goto _L1
    }
