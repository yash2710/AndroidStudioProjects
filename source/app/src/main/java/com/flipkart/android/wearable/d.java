    ...
    implements ResultCallback
{
    ...
    d(WearableDataSender wearabledatasender)
    {
    }
    ...
    public final void onResult(com.google.android.gms.wearable.DataApi.DataItemResult dataitemresult)
    {
        ...
        {
            FkLogger.error(WearableDataSender.a(), (new StringBuilder("ERROR: failed to putDataItem, status code: ")).append(dataitemresult.getStatus().getStatusCode()).append(" StatusMessage:").append(dataitemresult.getStatus().getStatusMessage()).toString());
        }
    }
}
