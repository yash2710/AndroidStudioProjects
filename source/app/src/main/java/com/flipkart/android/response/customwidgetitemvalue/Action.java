...
// Referenced classes of package com.flipkart.android.response.customwidgetitemvalue:
//            TrackingParams
...
public class Action
{
    ...
    {
        return (new StringBuilder("Action{screenType='")).append(screenType).append('\'').append(", omnitureData='").append(omnitureData).append('\'').append(", originalUrl='").append(originalUrl).append('\'').append(", url='").append(url).append('\'').append(", params=").append(params).append('}').toString();
    }
}
