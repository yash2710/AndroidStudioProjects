...
public class TwitterShareAppLoader extends AppActionLoader
{

    private static String a = "offerId";
    private static String b = "orderId";

    public TwitterShareAppLoader(AppParams appparams, Activity activity)
    {
    ...
    public void load()
    {
        ...
        ((HomeFragmentHolderActivity)activity).shareTwitter(AppConfigUtils.getInstance().getTwitterShareAppUrl(), "Hey, have you tried Flipkart's new mobile app yet? I think you'd like it. ", s, s1);
    }
