...
public class MarkAllReadRequest extends GsonRequest
{

    private InAppNotificationParam a;

    public MarkAllReadRequest(InAppNotificationParam inappnotificationparam, com.android.volley.Response.Listener listener, com.android.volley.Response.ErrorListener errorlistener)
    {
        super(1, constructSecureGetUri("2", "notification/markAllRead", ""), null, (new c()).getType(), listener, errorlistener);
        a = null;
