...
public class DeleteInAppNotificationRequest extends GsonRequest
{

    private InAppNotificationParam a;

    public DeleteInAppNotificationRequest(InAppNotificationParam inappnotificationparam, com.android.volley.Response.Listener listener, com.android.volley.Response.ErrorListener errorlistener)
    {
        super(3, constructSecureGetUri("2", "notification", inappnotificationparam.generateURI()), null, (new a()).getType(), listener, errorlistener);
        a = null;
