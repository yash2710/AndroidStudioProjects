...
import com.flipkart.android.utils.OmuWidgetBuilder;
...
public class OMUParentWidget extends ScrollWidget
{

    private static final String TAG = (new StringBuilder("ASIMO.")).append(com/flipkart/android/customwidget/OMUParentWidget.getSimpleName()).toString();
    public static final String WIDGET_COMMON_NAME = "OMU";
    private String requestId;

    public OMUParentWidget(Context context, LayoutDetails layoutdetails, BaseWidget.WidgetTheme widgettheme, android.view.View.OnClickListener onclicklistener, WidgetItem widgetitem, ArrayList arraylist, String s, 
    ...
    {
        if (!StringUtils.isNullOrEmpty(arraylist) && OmuWidgetBuilder.buildOmuWidget(activity, context, onClickListener, FlipkartApplication.getImageLoader(), arraylist, scrollLayout, true, action))
        {
            return;
        } else
        {
