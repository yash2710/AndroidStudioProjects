...
public class AutoSuggestFilter
    implements com.android.volley.RequestQueue.RequestFilter
{

    private String a;

    public AutoSuggestFilter(String s)
    {
        a = s;
    }
    ...
    {
        return (request instanceof AutoSuggestRequest) && ((AutoSuggestRequest)request).getRequestId().equals(a);
    }
}
