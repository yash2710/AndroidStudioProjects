...
_L1:
        a a1 = new a(s);
_L6:
        arraylist.add(com.google.mygson.o.newFactory(TypeToken.get(java/util/Date), a1));
        arraylist.add(com.google.mygson.o.newFactory(TypeToken.get(java/sql/Timestamp), a1));
        arraylist.add(com.google.mygson.o.newFactory(TypeToken.get(java/sql/Date), a1));
_L4:
...
_L5:
    ...
    public final GsonBuilder registerTypeAdapter(Type type, Object obj)
    {
        ...
        if ((obj instanceof JsonSerializer) || (obj instanceof JsonDeserializer))
        {
            ...
            e.add(com.google.mygson.o.newFactoryWithMatchRawType(typetoken, obj));
        }
    ...
    public final GsonBuilder registerTypeHierarchyAdapter(Class class1, Object obj)
    {
        ...
        {
            f.add(0, com.google.mygson.o.newTypeHierarchyFactory(class1, obj));
        }
        if (obj instanceof TypeAdapter)
        {
