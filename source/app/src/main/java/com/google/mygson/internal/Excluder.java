    ...
    implements TypeAdapterFactory, Cloneable
{
    ...
    {
        if (a != -1D && !a((Since)class1.getAnnotation(com/google/mygson/annotations/Since), (Until)class1.getAnnotation(com/google/mygson/annotations/Until)))
        {
            return true;
        }
        if (!c && b(class1))
...
label0:
        {
            ...
            if (a != -1D && !a((Since)field.getAnnotation(com/google/mygson/annotations/Since), (Until)field.getAnnotation(com/google/mygson/annotations/Until)))
            {
                return true;
            }
            ...
            if (d)
            {
                Expose expose = (Expose)field.getAnnotation(com/google/mygson/annotations/Expose);
