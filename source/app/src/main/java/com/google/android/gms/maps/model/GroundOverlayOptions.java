    ...
    implements SafeParcelable
{
    ...
    public final GroundOverlayOptions position(LatLng latlng, float f)
    {
        ...
        hm.a(flag1, "Position has already been set using positionFromBounds");
        if (latlng != null)
        {
            flag2 = flag;
        } else
        ...
        hm.b(flag2, "Location must be specified");
        if (f < 0.0F)
        {
            flag = false;
        }
    ...
    public final GroundOverlayOptions position(LatLng latlng, float f, float f1)
    {
        ...
        hm.b(flag3, "Width must be non-negative");
        if (f1 < 0.0F)
        {
            flag = false;
        }
    ...
    public final GroundOverlayOptions positionFromBounds(LatLngBounds latlngbounds)
    {
        ...
        aobj = new Object[1];
        aobj[0] = aaB;
        hm.a(flag, "Position has already been set using position: %s", aobj);
        aaE = latlngbounds;
        return this;
    }
