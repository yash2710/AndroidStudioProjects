    ...
    implements RealTimeMultiplayer
{
    ...
    public final RealTimeSocket getSocketForParticipant(GoogleApiClient googleapiclient, String s, String s1)
    {
    ...
    public final void leave(GoogleApiClient googleapiclient, RoomUpdateListener roomupdatelistener, String s)
    {
        Games.c(googleapiclient).a(roomupdatelistener, s);
    }

    public final int sendReliableMessage(GoogleApiClient googleapiclient, com.google.android.gms.games.multiplayer.realtime.RealTimeMultiplayer.ReliableMessageSentCallback reliablemessagesentcallback, byte abyte0[], String s, String s1)
    {
        return Games.c(googleapiclient).a(reliablemessagesentcallback, abyte0, s, s1);
    }

    public final int sendUnreliableMessage(GoogleApiClient googleapiclient, byte abyte0[], String s, String s1)
    {
    ...
    public final int sendUnreliableMessage(GoogleApiClient googleapiclient, byte abyte0[], String s, List list)
    {
        String as[] = (String[])list.toArray(new String[list.size()]);
        return Games.c(googleapiclient).a(abyte0, s, as);
    }

    public final int sendUnreliableMessageToOthers(GoogleApiClient googleapiclient, byte abyte0[], String s)
    {
