...
public final class <init>
{
    ...
    public final akB setAccountName(String s)
    {
        WalletFragmentInitParams.a(akB, s);
        return this;
    }

    public final akB setMaskedWallet(MaskedWallet maskedwallet)
    {
        WalletFragmentInitParams.a(akB, maskedwallet);
        return this;
    }

    public final akB setMaskedWalletRequest(MaskedWalletRequest maskedwalletrequest)
    {
        WalletFragmentInitParams.a(akB, maskedwalletrequest);
        return this;
    }

    public final akB setMaskedWalletRequestCode(int i)
    {
