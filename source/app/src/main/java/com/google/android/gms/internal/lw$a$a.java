...
public final class nz extends ma
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            class a extends ma
            {
                ...
                public final boolean equals(Object obj1)
                {
                    if (obj1 != this)
                    {
                        ...
                        if (Double.doubleToLongBits(amy) != Double.doubleToLongBits(a1.amy))
                        {
                            return false;
                        }
                        if (Float.floatToIntBits(amz) != Float.floatToIntBits(a1.amz))
                        {
                            return false;
                        }
                        if (amA != a1.amA)
                        ...
                        if (!mc.equals(amE, a1.amE))
                        {
                            return false;
                        }
                        if (!mc.equals(amF, a1.amF))
                        {
                            return false;
                        }
                        if (!mc.equals(amG, a1.amG))
                        {
                            return false;
                        }
                        if (!mc.equals(amH, a1.amH))
                        {
                            return false;
                        }
                        if (!mc.equals(amI, a1.amI))
                        {
                            return false;
                        }
                        if (amJ != a1.amJ)
            ...
            if (!amv.equals(na.amv))
            {
                return false;
            }
            if (amX == null || amX.isEmpty())
            {
                if (na.amX != null && !na.amX.isEmpty())
                {
                    return false;
                }
            } else
            {
                return amX.equals(na.amX);
            }
        }
        return true;
    }
