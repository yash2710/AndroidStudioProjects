    ...
    implements ba, bd, bf, bn, ci, cl, dm.a, ej, t
{
    ...
    private boolean kF;
    private final ComponentCallbacks kG = new _cls1();
    ...
    {
        eu.D((new StringBuilder("Failed to load ad: ")).append(i).toString());
        if (kC.kR == null)
        {
...
_L3:
        ...
        if (!ai1.lV)
        {
            eu.B((new StringBuilder("Use AdRequest.Builder.addTestDevice(\"")).append(et.r(kC.kO)).append("\") to get test ads on this device.").toString());
        }
        kD.cancel();
        kC.lb = false;
        a1 = c(ai1);
...
_L10:
    ...
    public void af()
    {
        if (kC.kU != null)
        {
            eu.D((new StringBuilder("Mediation adapter ")).append(kC.kU.nO).append(" refreshed, but mediation adapters should never refresh.").toString());
        }
        c(true);
        ak();
    }
    ...
    private class c
    {
            ...
            implements g, Runnable
        {
            ...
            public final void a(int i, int l, int i1)
            {
                g g1 = (g)kL.get();
                if (g1 != null)
                {
        ...
        private class a extends ViewSwitcher
        {
