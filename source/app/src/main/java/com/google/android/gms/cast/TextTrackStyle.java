...
_L3:
        ...
        if (i == 0)
        {
            ...
            {
                l = td;
                i1 = texttrackstyle.td;
                flag1 = false;
                if (l == i1)
                {
                    j1 = Bu;
                    k1 = texttrackstyle.Bu;
                    flag1 = false;
                    if (j1 == k1)
                    {
                        l1 = Bv;
                        i2 = texttrackstyle.Bv;
                        flag1 = false;
                        if (l1 == i2)
                        {
                            j2 = Bw;
                            k2 = texttrackstyle.Bw;
                            flag1 = false;
                            if (j2 == k2)
                            {
                                l2 = By;
                                i3 = texttrackstyle.By;
                                flag1 = false;
                                if (l2 == i3)
                                {
                                    flag4 = gi.a(Bz, texttrackstyle.Bz);
                                    flag1 = false;
                                    if (flag4)
                                    {
                                        j3 = BA;
                                        k3 = texttrackstyle.BA;
                                        flag1 = false;
                                        if (j3 == k3)
                                        {
                                            l3 = BB;
                                            i4 = texttrackstyle.BB;
                                            flag1 = false;
                                            if (l3 == i4)
                                            {
                                                return true;
