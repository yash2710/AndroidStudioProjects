...
public class r extends hb
{
    ...
    PendingResult a(GoogleApiClient googleapiclient, DriveId driveid, int i, com.google.android.gms.drive.events.DriveEvent.Listener listener)
    {
        ...
        k = new p.k(googleapiclient, Status.En);
        map;
        ...
        b1 = googleapiclient.b(new _cls1(driveid, i, x1));
        map;
        JVM INSTR monitorexit ;
        return b1;
        Exception exception;
    ...
    PendingResult b(GoogleApiClient googleapiclient, DriveId driveid, int i, com.google.android.gms.drive.events.DriveEvent.Listener listener)
    {
        ...
        p.k k = new p.k(googleapiclient, Status.En);
        map;
        JVM INSTR monitorexit ;
        return k;
        ...
        p.k k1 = new p.k(googleapiclient, Status.En);
        map;
        JVM INSTR monitorexit ;
        return k1;
        Exception exception;
        ...
        b1 = googleapiclient.b(new _cls2(driveid, i, x1));
        map;
        JVM INSTR monitorexit ;
        return b1;
    }
    ...
    private class _cls1 extends p.j
    {
        ...
        _cls1(DriveId driveid, int i, x x1)
        {
            IZ = r.this;
            IW = driveid;
            IX = i;
    ...
    private class _cls2 extends p.j
    {
        ...
        _cls2(DriveId driveid, int i, x x1)
        {
            IZ = r.this;
            IW = driveid;
            IX = i;
