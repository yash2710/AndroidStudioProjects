    ...
    implements ExtendedGame
{
    ...
    public final SnapshotMetadata hZ()
    {
        return RD;
    }
    ...
    public final GameEntity ia()
    {
        return Rt;
    }

    public final ExtendedGame ib()
    {
        return this;
    }
    ...
    private class ExtendedGameEntityCreatorCompat extends ExtendedGameEntityCreator
    {

        public final ExtendedGameEntity bg(Parcel parcel)
        {
