    ...
    implements SafeParcelable
{
    ...
    {
        return (new StringBuilder("ActivityRecognitionResult [probableActivities=")).append(UV).append(", timeMillis=").append(UW).append(", elapsedRealtimeMillis=").append(UX).append("]").toString();
    }
