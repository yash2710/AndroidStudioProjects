    ...
    implements GoogleApiClient
{
    ...
    final GoogleApiClient.ConnectionCallbacks Ei = new _cls2();
    private final com.google.android.gms.internal.hc.b Ej = new _cls3();

    public c(Context context, Looper looper, gy gy1, Map map, Fragment fragment, Set set, Set set1)
    {
        DR = DQ.newCondition();
        DX = 4;
        DY = 0;
        ...
        Api.b b1;
        Object obj;
        for (Iterator iterator2 = map.keySet().iterator(); iterator2.hasNext(); Ee.put(api.eB(), a(b1, obj, context, looper, gy1, Ei, new _cls4(b1))))
        {
    ...
    static ConnectionResult a(c c1, ConnectionResult connectionresult)
    {
...
_L2:
    ...
    private class _cls3
        implements com.google.android.gms.internal.hc.b
    {
