...
public class a
{
    ...
    public static int B(Parcel parcel)
    {
        ...
        if (ar(i1) != 20293)
        {
            throw new a((new StringBuilder("Expected object header. Got 0x")).append(Integer.toHexString(i1)).toString(), parcel);
        }
        int l1 = k1 + j1;
        if (l1 < k1 || l1 > parcel.dataSize())
        {
            throw new a((new StringBuilder("Size read is invalid start=")).append(k1).append(" end=").append(l1).toString(), parcel);
        } else
        {
            return l1;
        }
    ...
    private static void a(Parcel parcel, int i1, int j1)
    {
        ...
        if (k1 != j1)
        {
            throw new a((new StringBuilder("Expected size ")).append(j1).append(" got ").append(k1).append(" (0x").append(Integer.toHexString(k1)).append(")").toString(), parcel);
        } else
        {
            return;
        }
    ...
    private static void a(Parcel parcel, int i1, int j1, int k1)
    {
        if (j1 != k1)
        {
            throw new a((new StringBuilder("Expected size ")).append(k1).append(" got ").append(j1).append(" (0x").append(Integer.toHexString(j1)).append(")").toString(), parcel);
        } else
        {
            return;
        }
