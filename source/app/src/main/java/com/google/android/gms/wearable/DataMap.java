...
public class DataMap
{
    ...
    private static boolean a(DataMap datamap, DataMap datamap1)
    {
        ...
        for (Iterator iterator = datamap.keySet().iterator(); iterator.hasNext();)
        {
            ...
            if (obj instanceof String[])
            {
                ...
                if (!Arrays.equals((String[])obj, (String[])obj1))
                {
                    return false;
                }
            } else
    ...
    public static DataMap fromByteArray(byte abyte0[])
    {
        ...
        try
        {
            datamap = lv.a(new com.google.android.gms.internal.lv.a(lw.n(abyte0), new ArrayList()));
        }
        catch (md md1)
        {
            throw new IllegalArgumentException("Unable to convert data", md1);
        }
        return datamap;
    }
