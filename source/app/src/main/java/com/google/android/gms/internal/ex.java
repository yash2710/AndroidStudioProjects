...
_L1:
    ...
    public void b(String s, JSONObject jsonobject)
    {
        ...
        stringbuilder.append(s1);
        stringbuilder.append(");");
        eu.C((new StringBuilder("Dispatching AFMA event: ")).append(stringbuilder).toString());
        E(stringbuilder.toString());
    }
    ...
    public void onDownloadStart(String s, String s1, String s2, String s3, long l)
    {
        ...
        {
            eu.z((new StringBuilder("Couldn't find an Activity to view url/mimetype: ")).append(s).append(" / ").append(s3).toString());
        }
    }
...
_L3:
        ...
        f = sB.getResources().getDisplayMetrics().density;
        eu.D((new StringBuilder("Not enough space to show ad. Needs ")).append((int)((float)nF.widthPixels / f)).append("x").append((int)((float)nF.heightPixels / f)).append(" dp, but only has ").append((int)((float)j1 / f)).append("x").append((int)((float)l1 / f)).append(" dp.").toString());
        if (getVisibility() != 8)
        {
            setVisibility(4);
        }
