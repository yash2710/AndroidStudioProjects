...
label0:
    ...
    public final Manager addApi(Api api)
    {
        DL.put(api, null);
        List list = api.eA();
        int i = list.size();
    ...
    public final tionFailedListener addOnConnectionFailedListener(tionFailedListener tionfailedlistener)
    {
        DP.add(tionfailedlistener);
        return this;
    }

    public final DP addScope(Scope scope)
    {
        DH.add(scope.eP());
        return this;
    }
    ...
    public final tionFailedListener enableAutoManage(FragmentActivity fragmentactivity, tionFailedListener tionfailedlistener)
    {
    ...
    public final DN setAccountName(String s)
    {
        yQ = s;
        return this;
    }

    public final yQ setGravityForPopups(int i)
    {
        DI = i;
        return this;
    }

    public final DI setHandler(Handler handler)
    {
    ...
    public final DF setViewForPopups(View view)
    {
        DJ = view;
        return this;
    }

    public final DJ useDefaultAccount()
    {
