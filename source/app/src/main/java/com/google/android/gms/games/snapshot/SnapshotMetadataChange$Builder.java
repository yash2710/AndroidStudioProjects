...
public final class 
{
    ...
    public final Uh fromMetadata(SnapshotMetadata snapshotmetadata)
    {
    ...
    public final Uk setCoverImage(Bitmap bitmap)
    {
        Uk = new a(bitmap);
        Uh = null;
        return this;
    ...
    public final Uh setDescription(String s)
    {
        Mp = s;
        return this;
    }

    public final Mp setPlayedTimeMillis(long l)
    {
        Uj = Long.valueOf(l);
        return this;
    }
