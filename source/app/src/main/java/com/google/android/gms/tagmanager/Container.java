...
public class Container
{
    ...
    private void a(com.google.android.gms.internal.c.f f)
    {
        ...
        {
            bh.A((new StringBuilder("Not loading resource: ")).append(f).append(" because it is invalid: ").append(g.toString()).toString());
            return;
        }
        a(c);
    }
    ...
    private void a(cq.c c)
    {
        aez = c.getVersion();
        ag ag = bI(aez);
        a(new cs(mContext, c, aeu, new a(null), new b(null), ag));
    }
    ...
    FunctionCallMacroCallback bF(String s)
    {
        ...
        synchronized (aew)
        {
            functioncallmacrocallback = (FunctionCallMacroCallback)aew.get(s);
        }
    ...
    FunctionCallTagCallback bG(String s)
    {
        ...
        synchronized (aex)
        {
            functioncalltagcallback = (FunctionCallTagCallback)aex.get(s);
        }
    ...
    public boolean getBoolean(String s)
    {
        ...
        {
            bh.A((new StringBuilder("Calling getBoolean() threw an exception: ")).append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.na().booleanValue();
        }
        return flag;
    }
    ...
    public double getDouble(String s)
    {
        ...
        {
            bh.A((new StringBuilder("Calling getDouble() threw an exception: ")).append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.mZ().doubleValue();
        }
        return d;
    }
    ...
    public long getLong(String s)
    {
        ...
        {
            bh.A((new StringBuilder("Calling getLong() threw an exception: ")).append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.mY().longValue();
        }
        return l;
    }
    ...
    public String getString(String s)
    {
        ...
        try
        {
            s1 = dh.j((com.google.android.gms.internal.d.a)cs1.cj(s).getObject());
        }
        catch (Exception exception)
        {
            bh.A((new StringBuilder("Calling getString() threw an exception: ")).append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.nc();
        }
        return s1;
    }
