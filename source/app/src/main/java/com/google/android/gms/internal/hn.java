...
public final class hn extends g
{
    ...
    private View c(Context context, int i, int j)
    {
        ...
        {
            throw new com.google.android.gms.dynamic.g.a((new StringBuilder("Could not get button with size ")).append(i).append(" and color ").append(j).toString(), exception);
        }
        return view;
    }

    public final hj N(IBinder ibinder)
    {
