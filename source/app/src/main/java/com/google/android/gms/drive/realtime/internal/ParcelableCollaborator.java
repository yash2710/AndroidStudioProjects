    ...
    implements SafeParcelable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        } else
        {
            ...
            return rR.equals(parcelablecollaborator.rR);
        }
    }
    ...
    {
        return (new StringBuilder("Collaborator [isMe=")).append(Lk).append(", isAnonymous=").append(Ll).append(", sessionId=").append(rR).append(", userId=").append(Lm).append(", displayName=").append(Ln).append(", color=").append(Lo).append(", photoUrl=").append(Lp).append("]").toString();
    }
