...
public final class bz extends bu.a
{
    ...
    private MediationServerParameters b(String s, int i, String s1)
    {
        ...
        if (s != null)
        {
            try
            {
                JVM INSTR new #26  <Class JSONObject>;
    ...
    public final void a(d d, ai ai1, String s, String s1, bv bv)
    {
        ...
        {
            eu.D((new StringBuilder("MediationAdapter is not a MediationInterstitialAdapter: ")).append(nU.getClass().getCanonicalName()).toString());
            throw new RemoteException();
        }
    ...
    public final void a(d d, al al, ai ai1, String s, bv bv)
    {
        a(d, al, ai1, s, null, bv);
    }

    public final void a(d d, al al, ai ai1, String s, String s1, bv bv)
    {
        if (!(nU instanceof MediationBannerAdapter))
        {
            eu.D((new StringBuilder("MediationAdapter is not a MediationBannerAdapter: ")).append(nU.getClass().getCanonicalName()).toString());
            throw new RemoteException();
        }
