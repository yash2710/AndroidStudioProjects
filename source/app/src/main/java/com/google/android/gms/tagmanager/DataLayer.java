...
label0:
    ...
    static Long bO(String s)
    {
        ...
        if (!matcher.matches())
        {
            bh.B((new StringBuilder("unknown _lifetime: ")).append(s).toString());
            return null;
        }
...
_L2:
        if (l <= 0L)
        {
            bh.B((new StringBuilder("non-positive _lifetime: ")).append(s).toString());
            return null;
        }
        break; /* Loop/switch isn't completed */
        NumberFormatException numberformatexception;
        numberformatexception;
        bh.D((new StringBuilder("illegal number in _lifetime value: ")).append(s).toString());
        l = 0L;
...
_L1:
        ...
        {
        default:
            bh.D((new StringBuilder("unknown units in _lifetime: ")).append(s).toString());
            return null;
...
_L1:
    ...
    private class a
    {
        ...
        {
            return (new StringBuilder("Key: ")).append(JL).append(" value: ").append(afh.toString()).toString();
        }
