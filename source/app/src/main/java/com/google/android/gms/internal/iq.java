...
public class iq
{
    ...
    public static final MetadataField Kq = new _cls1("thumbnail", Collections.emptySet(), Collections.emptySet(), 0x432380);
    ...
    private class _cls1 extends j
    {
        ...
        protected final Object b(DataHolder dataholder, int i1, int j1)
        {
            return i(dataholder, i1, j1);
        }

        protected final com.google.android.gms.common.data.a i(DataHolder dataholder, int i1, int j1)
        {
            throw new IllegalStateException("Thumbnail field is write only");
        }

        _cls1(String s, Collection collection, Collection collection1, int i1)
        {
            super(s, collection, collection1, i1);
        }
    }
