...
public class hp
{
    ...
    public static String a(String s, String s1, Context context, AttributeSet attributeset, boolean flag, boolean flag1, String s2)
    {
        ...
        if (s3 != null && s3.startsWith("@string/") && flag)
        {
            ...
            {
                Log.w(s2, (new StringBuilder("Could not find resource for ")).append(s1).append(": ").append(s3).toString());
            }
            ...
            {
                Log.w(s2, (new StringBuilder("Resource ")).append(s1).append(" was not a string: ").append(typedvalue).toString());
            }
        }
        if (flag1 && s3 == null)
        {
