...
public class fa extends ey
{
    ...
    {
        HttpURLConnection httpurlconnection = (HttpURLConnection)HttpInstrumentation.openConnection((new URL(s1)).openConnection());
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webview, String s)
    {
        ...
        {
            eu.D((new StringBuilder("Could not fetching MRAID JS. ")).append(ioexception.getMessage()).toString());
            return super.shouldInterceptRequest(webview, s);
        }
        return webresourceresponse;
    }
