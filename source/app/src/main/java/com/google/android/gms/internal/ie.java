    ...
    implements SafeParcelable
{
    ...
    private static void a(ib ib1, hy hy1)
    {
        ...
        if (!ib1.b(class1))
        {
            ...
            do
            {
                ...
                hy.a a1 = (hy.a)hashmap.get((String)iterator.next());
                Class class2 = a1.fO();
                if (class2 != null)
                {
                    try
                    {
                        a(ib1, (hy)class2.newInstance());
                    }
                    catch (InstantiationException instantiationexception)
                    {
                        throw new IllegalStateException((new StringBuilder("Could not instantiate an object of type ")).append(a1.fO().getCanonicalName()).toString(), instantiationexception);
                    }
                    catch (IllegalAccessException illegalaccessexception)
                    {
                        throw new IllegalStateException((new StringBuilder("Could not access object of type ")).append(a1.fO().getCanonicalName()).toString(), illegalaccessexception);
                    }
                }
            } while (true);
        }
    ...
    private void a(StringBuilder stringbuilder, hy.a a1, Parcel parcel, int i)
    {
        ...
        {
        default:
            throw new IllegalArgumentException((new StringBuilder("Unknown field out type = ")).append(a1.fF()).toString());
    ...
    private static HashMap b(HashMap hashmap)
    {
        ...
        for (Iterator iterator = hashmap.entrySet().iterator(); iterator.hasNext(); hashmap1.put(Integer.valueOf(((hy.a)entry.getValue()).fN()), entry))
        {
...
_L13:
        ...
        while (k < j) 
        {
            ...
            a(stringbuilder, a1.fS(), aparcel[k]);
            k++;
        }
...
_L2:
        ...
        case 10: // '\n'
            ...
            for (boolean flag = true; iterator.hasNext(); flag = false)
            {
                ...
                stringbuilder.append("\"").append(s).append("\"");
                stringbuilder.append(":");
                stringbuilder.append("\"").append(in.aK(bundle.getString(s))).append("\"");
            }
    ...
    private void b(StringBuilder stringbuilder, hy.a a1, ArrayList arraylist)
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            a(stringbuilder, a1.fE(), arraylist.get(j));
        }
...
_L4:
    ...
    ib fZ()
    {
        ...
        {
        default:
            throw new IllegalStateException((new StringBuilder("Invalid creation type: ")).append(Hr).toString());
