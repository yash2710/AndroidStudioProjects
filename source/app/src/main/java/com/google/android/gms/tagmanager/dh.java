...
class dh
{
    ...
    private static dg cq(String s1)
    {
        ...
        {
            bh.A((new StringBuilder("Failed to convert '")).append(s1).append("' to a number.").toString());
            return aiq;
        }
        return dg1;
    }
    ...
    public static Object o(com.google.android.gms.internal.d.a a)
    {
        ...
        {
        default:
            bh.A((new StringBuilder("Failed to convert a value of type: ")).append(a.type).toString());
            return ain;
        ...
        case 3: // '\003'
            ...
            {
                bh.A((new StringBuilder("Converting an invalid value to object: ")).append(a.toString()).toString());
                return ain;
            }
