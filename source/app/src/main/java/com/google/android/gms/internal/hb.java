    ...
    implements com.google.android.gms.common.api.Api.a, hc.b
{
    ...
    public void connect()
    {
        ...
        } else
        {
            ...
            {
                Log.e("GmsClient", (new StringBuilder("unable to connect to service: ")).append(bu()).toString());
...
_L1:
    ...
    private class h extends b
    {
        ...
        protected final void b(Boolean boolean1)
        {
            if (boolean1 == null)
            {
                hb.a(Gi, 1);
            ...
            default:
                ...
                if (Gn != null)
                {
                    pendingintent = (PendingIntent)Gn.getParcelable("pendingIntent");
                } else
                {
                    pendingintent = null;
                }
                ...
                hb.a(Gi, 1);
                hb.a(Gi, null);
                hb.a(Gi).a(new ConnectionResult(statusCode, pendingintent));
                return;

            case 0: // '\0'
                try
                {
                    s = Go.getInterfaceDescriptor();
                    if (Gi.bv().equals(s))
                    {
                        hb.a(Gi, Gi.x(Go));
                        if (hb.c(Gi) != null)
