    ...
    implements SafeParcelable
{
    ...
    public String toString()
    {
        ...
        stringbuilder.append((new StringBuilder(", mAddress=")).append(YL).toString());
        stringbuilder.append((new StringBuilder(", mType=")).append(AT).toString());
        stringbuilder.append((new StringBuilder(", mRole=")).append(ali).toString());
        stringbuilder.append((new StringBuilder(", mEnabled=")).append(alj).toString());
