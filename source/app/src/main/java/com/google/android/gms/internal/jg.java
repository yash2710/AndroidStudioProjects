...
public class jg extends hb
{
    ...
    public void addGeofences(List list, PendingIntent pendingintent, com.google.android.gms.location.LocationClient.OnAddGeofencesResultListener onaddgeofencesresultlistener)
    {
        ...
        {
            obj = new b(onaddgeofencesresultlistener, this);
        }
        ((je)ft()).a(list, pendingintent, ((jd) (obj)), getContext().getPackageName());
    }
    ...
    public void removeGeofences(PendingIntent pendingintent, com.google.android.gms.location.LocationClient.OnRemoveGeofencesResultListener onremovegeofencesresultlistener)
    {
        ...
        {
            obj = new b(onremovegeofencesresultlistener, this);
        }
        ((je)ft()).a(pendingintent, ((jd) (obj)), getContext().getPackageName());
    }
    ...
    public void removeGeofences(List list, com.google.android.gms.location.LocationClient.OnRemoveGeofencesResultListener onremovegeofencesresultlistener)
    {
        ...
        ((je)ft()).a(as, ((jd) (obj)), getContext().getPackageName());
    }
    ...
    private class b extends jd.a
    {
        ...
        private class a extends hb.b
        {
            ...
            protected final void a(com.google.android.gms.location.LocationClient.OnAddGeofencesResultListener onaddgeofencesresultlistener)
            {
                if (onaddgeofencesresultlistener != null)
                {
        ...
        private class d extends hb.b
        {
            ...
            protected final void a(com.google.android.gms.location.LocationClient.OnRemoveGeofencesResultListener onremovegeofencesresultlistener)
            {
label0:
                {
label1:
                    {
                        if (onremovegeofencesresultlistener != null)
                        {
                            ...
                            {
                            default:
                                Log.wtf("LocationClientImpl", (new StringBuilder("Unsupported action: ")).append(VY).toString());
                                break;
