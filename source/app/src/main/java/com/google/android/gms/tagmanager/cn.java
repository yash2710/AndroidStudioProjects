    ...
    implements Runnable
{
    ...
    cn(Context context, String s, bm bm1, r r1)
    {
        ...
        aet = s;
        agO = r1;
        agM = (new StringBuilder("/r?id=")).append(s).toString();
        aeP = agM;
        agP = null;
    }
    ...
    private void mh()
    {
        ...
        bh.C((new StringBuilder("Successfully loaded supplemented resource: ")).append(j).toString());
        if (j.fK == null && j.fJ.length == 0)
        {
            bh.C((new StringBuilder("No change for container: ")).append(aet).toString());
        }
        agN.i(j);
        bl1.close();
        ...
        bh.D((new StringBuilder("No data is retrieved from the given url: ")).append(s).append(". Make sure container_id: ").append(aet).append(" is correct.").toString());
        agN.a(bg.a.agi);
        bl1.close();
        return;
        IOException ioexception;
        ioexception;
        bh.c((new StringBuilder("Error when loading resources from url: ")).append(s).append(" ").append(ioexception.getMessage()).toString(), ioexception);
        agN.a(bg.a.agh);
        bl1.close();
        return;
        IOException ioexception1;
        ioexception1;
        bh.c((new StringBuilder("Error when parsing downloaded resources from url: ")).append(s).append(" ").append(ioexception1.getMessage()).toString(), ioexception1);
        agN.a(bg.a.agi);
        bl1.close();
        return;
        Exception exception;
    ...
    void bM(String s)
    {
        ...
        {
            bh.z((new StringBuilder("Setting CTFE URL path: ")).append(s).toString());
            aeP = s;
            return;
        }
    }
    ...
    void cb(String s)
    {
        bh.z((new StringBuilder("Setting previous container version: ")).append(s).toString());
        agP = s;
    }
