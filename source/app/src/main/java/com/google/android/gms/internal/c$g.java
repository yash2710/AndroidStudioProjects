...
public final class m extends ma
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            fw fw1 = (fw)obj;
            if (!mc.equals(fn, fw1.fn))
            {
                return false;
            }
            if (!mc.equals(fo, fw1.fo))
            {
                return false;
            }
            if (!mc.equals(fp, fw1.fp))
            {
                return false;
            }
            if (!mc.equals(fq, fw1.fq))
            {
                return false;
            }
            if (!mc.equals(fr, fw1.fr))
            {
                return false;
            }
            if (!mc.equals(fs, fw1.fs))
            {
                return false;
            }
            if (!mc.equals(ft, fw1.ft))
            {
                return false;
            }
            if (!mc.equals(fu, fw1.fu))
            {
                return false;
            }
            if (!mc.equals(fv, fw1.fv))
            {
                return false;
            }
            if (!mc.equals(fw, fw1.fw))
            {
                return false;
            }
            if (amX == null || amX.isEmpty())
            {
                if (fw1.amX != null && !fw1.amX.isEmpty())
                {
                    return false;
                }
            } else
