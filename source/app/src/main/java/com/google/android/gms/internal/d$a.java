...
public final class s extends ma
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            if (!mc.equals(fO, fu.fO))
            {
                return false;
            }
            if (!mc.equals(fP, fu.fP))
            {
                return false;
            }
            if (!mc.equals(fQ, fu.fQ))
            {
                return false;
            }
            if (fR == null)
            ...
            if (!mc.equals(fV, fu.fV))
            {
                return false;
            }
            if (!mc.equals(fW, fu.fW))
            {
                return false;
            }
            if (fX != fu.fX)
