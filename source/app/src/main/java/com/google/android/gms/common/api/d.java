...
public class d extends Fragment
    implements android.content.DialogInterface.OnCancelListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, TraceFieldInterface
{
...
_L2:
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        TraceMachine.enterMethod(_nr_trace, "d#onCreate", null);
_L1:
