    ...
    implements bc
{
    ...
    private static int a(DisplayMetrics displaymetrics, Map map, String s, int i)
    {
        ...
        if (s1 != null)
        {
            ...
            {
                eu.D((new StringBuilder("Could not parse ")).append(s).append(" in a video GMSG: ").append(s1).toString());
                return i;
            }
            i = j;
        }
    ...
    public final void b(ex ex1, Map map)
    {
        ...
        if ("currentTime".equalsIgnoreCase(s))
        {
            ...
            {
                eu.D((new StringBuilder("Could not parse time parameter from currentTime video GMSG: ")).append(s1).toString());
            }
            return;
        }
        ...
        {
            eu.D((new StringBuilder("Unknown video action: ")).append(s).toString());
            return;
        }
    }
}
