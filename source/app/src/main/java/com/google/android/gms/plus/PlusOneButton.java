...
public final class PlusOneButton extends FrameLayout
{
    ...
    {
        String s = hp.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attributeset, true, false, "PlusOneButton");
        byte byte0;
    ...
    {
        String s = hp.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attributeset, true, false, "PlusOneButton");
    ...
    public final void initialize(String s, OnPlusOneClickListener onplusoneclicklistener)
    {
        qY = s;
        abD = 0;
        C(getContext());
        ...
        implements android.view.View.OnClickListener, OnPlusOneClickListener
    {
        ...
        {
            Intent intent = (Intent)PlusOneButton.a(abG).getTag();
            if (abF != null)
            {
                abF.onPlusOneClick(intent);
                return;
            } else
            {
