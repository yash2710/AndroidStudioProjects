    ...
    implements bq.a
{
    ...
    private bu aP()
    {
        eu.B((new StringBuilder("Instantiating mediation adapter: ")).append(nC).toString());
        bu bu1;
        try
        {
            bu1 = kB.m(nC);
        ...
        {
            eu.a((new StringBuilder("Could not instantiate mediation adapter: ")).append(nC).toString(), remoteexception);
            return null;
        }
        return bu1;
    }
    ...
    public final bq b(long l, long l1)
    {
        bq bq1;
        synchronized (ls)
        {
