    ...
    implements SafeParcelable
{
    ...
    public final boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (mPriority != locationrequest.mPriority || Vl != locationrequest.Vl || Vm != locationrequest.Vm || Vn != locationrequest.Vn || Vb != locationrequest.Vb || Vo != locationrequest.Vo || Vp != locationrequest.Vp)
            {
                return false;
            }
        }
    ...
    public final int hashCode()
    {
        ...
        aobj[2] = Long.valueOf(Vm);
        aobj[3] = Boolean.valueOf(Vn);
        aobj[4] = Long.valueOf(Vb);
        aobj[5] = Integer.valueOf(Vo);
        aobj[6] = Float.valueOf(Vp);
    ...
    public final String toString()
    {
        ...
        {
            long l = Vb - SystemClock.elapsedRealtime();
