...
_L4:
        ...
        aa.C((new StringBuilder("PackageManager doesn't know about package: ")).append(namenotfoundexception).toString());
...
_L5:
    ...
    void a(w w1)
    {
        ...
        {
            tC = w1.cZ();
            aa.C((new StringBuilder("app name loaded: ")).append(tC).toString());
        }
        if (w1.da())
        {
            tD = w1.db();
            aa.C((new StringBuilder("app version loaded: ")).append(tD).toString());
        }
        if (w1.dc())
        {
            int i = P(w1.dd());
            if (i >= 0)
            {
                aa.C((new StringBuilder("log level loaded: ")).append(i).toString());
