...
//            SupportErrorDialogFragment, ErrorDialogFragment, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException
...
_L1:
        ...
        if (bundle != null)
        {
            ...
            {
                throw new IllegalStateException((new StringBuilder("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 5089000 but found ")).append(i).append(".  You must have the following declaration within the <application> element: ").append("    <meta-data android:name=\"com.google.android.gms.version").append("\" android:value=\"@integer/google_play_services_version\" />").toString());
            }
        } else
        {
...
_L5:
        ...
        {
        default:
            Log.e("GooglePlayServicesUtil", (new StringBuilder("Unexpected error code ")).append(i).toString());
...
_L4:
    ...
    public static boolean b(PackageManager packagemanager, String s)
    {
        ...
        catch (android.content.pm.PackageManager.NameNotFoundException namenotfoundexception)
        {
            ...
            {
                Log.d("GooglePlayServicesUtil", (new StringBuilder("Package manager can't find package ")).append(s).append(", defaulting to false").toString());
            }
            return false;
        }
    ...
    public static int isGooglePlayServicesAvailable(Context context)
    {
        ...
        if (ii.aD(packageinfo.versionCode))
        {
            ...
            if (!ey())
            {
                ...
                {
                    Log.w("GooglePlayServicesUtil", (new StringBuilder("Calling package ")).append(packageinfo2.packageName).append(" signature (test key) invalid on Glass.").toString());
                    return 9;
                }
            } else
            {
                ...
                {
                    Log.w("GooglePlayServicesUtil", (new StringBuilder("Calling package ")).append(packageinfo2.packageName).append(" signature (release key) invalid on Glass.").toString());
                    return 9;
                }
            }
        } else
    ...
    abyte0
        ...
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder("Google Play services out of date.  Requires 5089000 but found ")).append(packageinfo.versionCode).toString());
            return 2;
        }
