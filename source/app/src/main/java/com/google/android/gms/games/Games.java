...
public final class Games
{
    ...
    static 
    {
        ...
        com.google.android.gms.common.api.Api.c c1 = yH;
        ...
        com.google.android.gms.common.api.Api.b b1 = yI;
        com.google.android.gms.common.api.Api.c c2 = yH;
        Scope ascope1[] = new Scope[1];
        ascope1[0] = MI;
        MJ = new Api(b1, c2, ascope1);
    }
        ...
        implements com.google.android.gms.common.api.Api.b
    {
        ...
        public final GamesClientImpl a(Context context, Looper looper, gy gy1, GamesOptions gamesoptions, com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks connectioncallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener)
        {
            if (gamesoptions == null)
            {
                gamesoptions = new GamesOptions(null);
            }
            return new GamesClientImpl(context, looper, gy1.fn(), gy1.fj(), connectioncallbacks, onconnectionfailedlistener, gy1.fm(), gy1.fk(), gy1.fo(), gamesoptions.MM, gamesoptions.MN, gamesoptions.MO, gamesoptions.MP, gamesoptions.MQ, gamesoptions.MR);
        }
