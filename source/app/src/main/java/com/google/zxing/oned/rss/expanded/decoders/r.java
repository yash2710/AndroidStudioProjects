...
final class r
{
    ...
    private static String a(int i, int j, String s)
    {
        ...
        String s4 = (new StringBuilder("(")).append(s1).append(')').append(s2).toString();
        String s5 = a(s3);
        if (s5 == null)
        {
            return s4;
    ...
    private static String b(int i, int j, String s)
    {
        ...
        s2 = s.substring(i, k);
        s3 = s.substring(k);
        s4 = (new StringBuilder("(")).append(s1).append(')').append(s2).toString();
        s5 = a(s3);
        if (s5 == null)
        {
            return s4;
    ...
    static 
    {
        ...
        aobj124[0] = "8110";
        aobj124[1] = a;
        aobj124[2] = Integer.valueOf(70);
        aobj107[16] = aobj124;
        Object aobj125[] = new Object[3];
        aobj125[0] = "8200";
        aobj125[1] = a;
        aobj125[2] = Integer.valueOf(70);
        aobj107[17] = aobj125;
        e = aobj107;
    }
}
