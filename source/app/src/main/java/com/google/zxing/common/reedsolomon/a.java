...
_L5:
    ...
    final a[] c(a a1)
    {
        ...
        a a2 = a.a();
        int i = a1.a(-1 + a1.b.length);
        int j = a.c(i);
        a a3 = a2;
        a a4;
        a a5;
        for (a4 = this; -1 + a4.b.length >= -1 + a1.b.length && !a4.c(); a4 = a4.a(a5))
        {
            int k = (-1 + a4.b.length) - (-1 + a1.b.length);
            int l = a.c(a4.a(-1 + a4.b.length), j);
            a5 = a1.a(k, l);
            a3 = a3.a(a.a(k, l));
        }
