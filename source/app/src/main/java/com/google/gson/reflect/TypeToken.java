...
public class TypeToken
{
    ...
    protected TypeToken()
    {
        ...
        {
            b = com.google.gson.internal..Gson.Types.canonicalize(((ParameterizedType)type).getActualTypeArguments()[0]);
            a = com.google.gson.internal..Gson.Types.getRawType(b);
            c = b.hashCode();
            return;
        }
    }
    ...
    {
        b = com.google.gson.internal..Gson.Types.canonicalize((Type)com.google.gson.internal..Gson.Preconditions.checkNotNull(type));
        a = com.google.gson.internal..Gson.Types.getRawType(b);
        c = b.hashCode();
    }
...
_L2:
    ...
    {
        return (obj instanceof TypeToken) && com.google.gson.internal..Gson.Types.equals(b, ((TypeToken)obj).b);
    }
    ...
    public boolean isAssignableFrom(Type type)
    {
        ...
        {
            return a.isAssignableFrom(com.google.gson.internal..Gson.Types.getRawType(type));
        }
        ...
        {
            return a.isAssignableFrom(com.google.gson.internal..Gson.Types.getRawType(type)) && a(type, (GenericArrayType)b);
        } else
        {
            throw a(b, new Class[] {
    ...
    {
        return com.google.gson.internal..Gson.Types.typeToString(b);
    }
}
