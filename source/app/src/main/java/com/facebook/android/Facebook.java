...
public class Facebook
{
    ...
    private void authorize(Activity activity, String as[], int i, SessionLoginBehavior sessionloginbehavior, final DialogListener listener)
    {
        ...
        _lcls1 = new _cls1();
        openrequest = (new com.facebook.Session.OpenRequest(activity)).setCallback(_lcls1).setLoginBehavior(sessionloginbehavior).setRequestCode(i).setPermissions(Arrays.asList(pendingAuthorizationPermissions));
...
_L3:
        ...
        if (session6 == null) goto _L2; else goto _L1
_L1:
        return session6;
        Exception exception1;
        exception1;
