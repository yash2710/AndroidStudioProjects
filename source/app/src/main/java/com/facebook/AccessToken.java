    ...
    implements Serializable
{
    ...
    public static AccessToken createFromExistingAccessToken(String s, Date date, Date date1, AccessTokenSource accesstokensource, List list)
    {
        ...
        if (date1 == null)
        {
            date3 = DEFAULT_LAST_REFRESH_TIME;
        } else
        {
            date3 = date1;
        }
        ...
        {
            accesstokensource1 = DEFAULT_ACCESS_TOKEN_SOURCE;
        } else
        {
            accesstokensource1 = accesstokensource;
        }
        return new AccessToken(s, date2, list, accesstokensource1, date3);
    }
    ...
    private static Date getBundleLongAsDate(Bundle bundle, String s, Date date)
    {
        ...
        {
            return new Date(date.getTime() + l1 * 1000L);
        }
    }
