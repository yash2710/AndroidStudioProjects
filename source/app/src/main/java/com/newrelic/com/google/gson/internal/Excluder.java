    ...
    implements TypeAdapterFactory, Cloneable
{
    ...
    {
        if (a != -1D && !a((Since)class1.getAnnotation(com/newrelic/com/google/gson/annotations/Since), (Until)class1.getAnnotation(com/newrelic/com/google/gson/annotations/Until)))
        {
            return true;
        }
        if (!c && b(class1))
...
label0:
        {
            ...
            if (a != -1D && !a((Since)field.getAnnotation(com/newrelic/com/google/gson/annotations/Since), (Until)field.getAnnotation(com/newrelic/com/google/gson/annotations/Until)))
            {
                return true;
            }
