    ...
    implements TypeAdapterFactory
{
    ...
    public final TypeAdapter create(Gson gson, TypeToken typetoken)
    {
        ...
        java.lang.reflect.Type atype[] = com.newrelic.com.google.gson.internal..Gson.Types.getMapKeyAndValueTypes(type, com.newrelic.com.google.gson.internal..Gson.Types.getRawType(type));
        java.lang.reflect.Type type1 = atype[0];
        TypeAdapter typeadapter;
        TypeAdapter typeadapter1;
        com.newrelic.com.google.gson.internal.ObjectConstructor objectconstructor;
